  ...
  login() async {
    if (_key.currentState!.validate()) {
      try {
        ...
        print(data);
        // var data = '{"password":"Mayur@123","version":"2.9.8","email":"mayur@physician.com"}';
        ...
        if (res.statusCode == 200) {
          ...
          if (jsonDecode(res.body)['success'] == true) {
            Navigator.pushReplacement(context,
              ...
              return Homescreen(token: jsonDecode(res.body)['token'],);
            }));
          } else {
            return showDialog(
                context: context,
              ...
              child: TextFormField(
                ...
                validator: (String? value) {
                  if (!isPassworrd(value)) {
                    return "Enter password must contains 1 digit, 1 lowercase letter, 1 uppercase letter upto 8 letters.";
                  }
                },
                // maxLength: 8,
                decoration: InputDecoration(
